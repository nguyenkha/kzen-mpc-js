    ...
    if (!this.results) {
      ...
      switch (this.step) {
        case 0: {
          ...
          result = {
            vssScheme,
            secretShare: secretShare.map((s, i) => encrypt(Buffer.from(this.encryptionKeys[i], 'hex'), Buffer.from(s.padStart(64, 0), 'hex'))),
          };
          break;
        }
        case 1: {
          ...
          this.partyShares = this.results
            ...
            .map((e, i) => decrypt(Buffer.from(this.encryptionKeys[i], 'hex'), e).toString('hex'));
    ...
    if (!this.results) {
      ...
      switch (this.step) {
        case 0: {
          ...
          result = {
            vssScheme,
            secretShare: secretShare.map((s, i) => encrypt(Buffer.from(this.share.encryptionKeys[this.share.parties.indexOf(this.parties[i])], 'hex'), Buffer.from(s.padStart(64, 0), 'hex'))),
          };
          break;
        }
        case 1: {
          ...
          this.partyShares = this.results
            .map(r => r.secretShare[this.parties.indexOf(this.index)])
            .map((e, i) => decrypt(Buffer.from(this.share.encryptionKeys[this.share.parties.indexOf(this.parties[i])], 'hex'), e).toString('hex'));
    ...
    if (!this.results) {
      ...
      switch (this.step) {
        case 0: {
          ...
          this.stage2Result = Ok;
          result = {
            mbgi: this.parties.map((p, i) => p === this.index ? null : encrypt(Buffer.from(this.share.encryptionKeys[this.share.parties.indexOf(p)], 'hex'), Buffer.from(JSON.stringify(this.stage2Result.gamma_i_vec[i > this.parties.indexOf(this.index) ? i - 1 : i][0])))),
            mbwi: this.parties.map((p, i) => p === this.index ? null : encrypt(Buffer.from(this.share.encryptionKeys[this.share.parties.indexOf(p)], 'hex'), Buffer.from(JSON.stringify(this.stage2Result.w_i_vec[i > this.parties.indexOf(this.index) ? i - 1 : i][0])))),
          };
          break;
        }
        case 1: {
          this.mbgis = this.results.map((r, i) => r.mbgi[this.parties.indexOf(this.index)] ? JSON.parse(decrypt(Buffer.from(this.share.encryptionKeys[this.share.parties.indexOf(this.parties[i])], 'hex'), r.mbgi[this.parties.indexOf(this.index)])) : null).filter(m => m);
          const mbwis = this.results.map((r, i) => r.mbwi[this.parties.indexOf(this.index)] ? JSON.parse(decrypt(Buffer.from(this.share.encryptionKeys[this.share.parties.indexOf(this.parties[i])], 'hex'), r.mbwi[this.parties.indexOf(this.index)])) : null).filter(m => m);
